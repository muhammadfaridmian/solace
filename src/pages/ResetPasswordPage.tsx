    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-bg-primary px-[16px]">
        ...
        >
          ...
          <h2 className="font-display text-[24px] text-text-primary mb-[8px]">Password updated</h2>
    ...
    <div className="min-h-screen flex items-center justify-center bg-bg-primary px-[16px] py-[40px]">
      ...
      >
        ...
        <div className="text-center mb-[32px]">
          ...
          <h1 className="font-display text-[28px] sm:text-[32px] text-text-primary mb-[6px]">Set new password</h1>
